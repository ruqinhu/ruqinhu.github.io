...
作者：JanYork_简昀  
原文链接：https://cloud.tencent.com/developer/article/2647756

---

# 工程技术：在智能体优先的世界中利用 Codex（转）

![作者头像](/docs/assets/images/reprint/harness-engineering/c30dedf2aedc1f4e7ae9d7131e383ff1.jpg)
...
![Image](/docs/assets/images/reprint/harness-engineering/2166d9624ed3f5dc62745b22d2a516e3.png)
...
![Codex 通过 Chrome DevTools MCP 驱动应用，并在循环中验证自己的修复是否真正生效。](/docs/assets/images/reprint/harness-engineering/1c57d7134b9ba5cea6ca0d259f36ae5d.jpg)
...
![Codex 在本地开发环境中使用完整的可观测性堆栈，对日志、指标与追踪进行查询、关联和推理。](/docs/assets/images/reprint/harness-engineering/b05385c676739652c566291332a51a16.svg)
...
![凡是不在代码仓库里、不能被运行时上下文访问的知识，对 Codex 来说都等同于不存在。](/docs/assets/images/reprint/harness-engineering/dceb8bd4c16a76e559ff4b86a25a0084.jpg)
...
![带有显式横切边界的分层领域架构。](/docs/assets/images/reprint/harness-engineering/7116040cd91010c9334806a141c8de95.jpg)
...
[工作](https://cloud.tencent.com/developer/tag/17284)
